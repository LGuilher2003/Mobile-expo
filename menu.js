...
export default function Menu({ navigation }) {
  const apertar = () => {
    ...
    navigation.navigate('churrasqueria1');
    navigation.navigate('churrasqueria2');
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      color='#cd853f'
      onPress={() => navigation.navigate('churrasqueria1')} 
      />
      <Text> </Text>
      <Button
      title="Churrasqueira 2"
      color='#cd853f'
      onPress={() => navigation.navigate('churrasqueria2')} 
      />
      <Text> </Text>
      <Button
